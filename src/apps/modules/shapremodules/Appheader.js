...
function Appheader() {
const userinfo =JSON.parse(localStorage.getItem("userpass"));
        ...
        <header class="p-3 text-bg-dark">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <div class="text-end"> <button type="button" class="btn btn-outline-light me-2">Login</button> <button type="button" class="btn btn-warning">Sign-up</button>
                        <p>{userinfo.jemail}</p>
                     </div> </div> </div> </header>
    )
}
